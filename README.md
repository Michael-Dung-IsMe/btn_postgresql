...
- **Hiển thị bản đồ tĩnh:** Sử dụng Matplotlib để vẽ và hiển thị các lớp dữ liệu không gian (Polygon, LineString, Point).
- **Bảng điều khiển tương tác:** Cho phép lọc hiển thị theo khu dân cư, khu công nghiệp và thay đổi bán kính vùng đệm (buffer) của các điểm thu gom rác.
